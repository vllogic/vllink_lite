...
struct __gd32f3x0_common_t {
    struct {
        vsf_swi_handler_t *handler;
        void *param;
    } swi[__VSF_DEV_SWI_NUM];
};
typedef struct __gd32f3x0_common_t __gd32f3x0_common_t;
#endif
...
#if __VSF_DEV_SWI_NUM > 0
static __gd32f3x0_common_t __gd32f3x0_common;
#endif
...
// SWI
#if __VSF_DEV_SWI_NUM > 0
REPEAT_MACRO(__VSF_DEV_SWI_NUM, __GD32F3X0_SWI, NULL)
