...
#	ifdef PROJ_CFG_EXT_IO_AUTO_CHECK
		else	// do ext io connectable check
		{
			bool check_pass = true;
			
			vsfhal_gpio_init(0);	// PA
			vsfhal_gpio_init(1);	// PB

			vsfhal_gpio_config(PERIPHERAL_GPIO_TMS_MO_PORT, PERIPHERAL_GPIO_TMS_MO_PIN, VSFHAL_GPIO_INPUT | VSFHAL_GPIO_PULLDOWN);
			vsfhal_gpio_config(PERIPHERAL_GPIO_TMS_MI_PORT, PERIPHERAL_GPIO_TMS_MI_PIN, VSFHAL_GPIO_INPUT | VSFHAL_GPIO_PULLDOWN);
			vsfhal_gpio_config(PERIPHERAL_GPIO_TDI_PORT, PERIPHERAL_GPIO_TDI_PIN, VSFHAL_GPIO_OUTPP);
			vsfhal_gpio_set(PERIPHERAL_GPIO_TDI_PORT, 0x1 << PERIPHERAL_GPIO_TDI_PIN);
			
			vsfhal_gpio_config(PERIPHERAL_GPIO_TRST_MO_PORT, PERIPHERAL_GPIO_TRST_MO_PIN, VSFHAL_GPIO_INPUT | VSFHAL_GPIO_PULLDOWN);
			vsfhal_gpio_config(PERIPHERAL_GPIO_TRST_TX1_PORT, PERIPHERAL_GPIO_TRST_TX1_PIN, VSFHAL_GPIO_INPUT | VSFHAL_GPIO_PULLDOWN);
			vsfhal_gpio_config(PERIPHERAL_GPIO_TCK0_PORT, PERIPHERAL_GPIO_TCK0_PIN, VSFHAL_GPIO_OUTPP);
			vsfhal_gpio_set(PERIPHERAL_GPIO_TCK0_PORT, 0x1 << PERIPHERAL_GPIO_TCK0_PIN);
			
			vsfhal_gpio_config(PERIPHERAL_GPIO_TX0_PORT, PERIPHERAL_GPIO_TX0_PIN, VSFHAL_GPIO_INPUT | VSFHAL_GPIO_PULLDOWN);
			vsfhal_gpio_config(PERIPHERAL_GPIO_SRST_PORT, PERIPHERAL_GPIO_SRST_PIN, VSFHAL_GPIO_OUTPP);
			vsfhal_gpio_set(PERIPHERAL_GPIO_SRST_PORT, 0x1 << PERIPHERAL_GPIO_SRST_PIN);
			
			vsfhal_gpio_config(PERIPHERAL_GPIO_TDO_MI_PORT, PERIPHERAL_GPIO_TDO_MI_PIN, VSFHAL_GPIO_INPUT | VSFHAL_GPIO_PULLDOWN);
			vsfhal_gpio_config(PERIPHERAL_GPIO_TDO_RX1_PORT, PERIPHERAL_GPIO_TDO_RX1_PIN, VSFHAL_GPIO_INPUT | VSFHAL_GPIO_PULLDOWN);
			vsfhal_gpio_config(PERIPHERAL_GPIO_RX0_PORT, PERIPHERAL_GPIO_RX0_PIN, VSFHAL_GPIO_OUTPP);
			vsfhal_gpio_set(PERIPHERAL_GPIO_RX0_PORT, 0x1 << PERIPHERAL_GPIO_RX0_PIN);
			
			if (!vsfhal_gpio_get(PERIPHERAL_GPIO_TMS_MO_PORT, 0x1 << PERIPHERAL_GPIO_TMS_MO_PIN) ||
					!vsfhal_gpio_get(PERIPHERAL_GPIO_TMS_MI_PORT, 0x1 << PERIPHERAL_GPIO_TMS_MI_PIN) ||
					!vsfhal_gpio_get(PERIPHERAL_GPIO_TRST_MO_PORT, 0x1 << PERIPHERAL_GPIO_TRST_MO_PIN) ||
					!vsfhal_gpio_get(PERIPHERAL_GPIO_TRST_TX1_PORT, 0x1 << PERIPHERAL_GPIO_TRST_TX1_PIN) ||
					!vsfhal_gpio_get(PERIPHERAL_GPIO_TX0_PORT, 0x1 << PERIPHERAL_GPIO_TX0_PIN) ||
					!vsfhal_gpio_get(PERIPHERAL_GPIO_TDO_MI_PORT, 0x1 << PERIPHERAL_GPIO_TDO_MI_PIN) ||
					!vsfhal_gpio_get(PERIPHERAL_GPIO_TDO_RX1_PORT, 0x1 << PERIPHERAL_GPIO_TDO_RX1_PIN))
				check_pass = false;


			vsfhal_gpio_config(PERIPHERAL_GPIO_TMS_MO_PORT, PERIPHERAL_GPIO_TMS_MO_PIN, VSFHAL_GPIO_INPUT | VSFHAL_GPIO_PULLUP);
			vsfhal_gpio_config(PERIPHERAL_GPIO_TMS_MI_PORT, PERIPHERAL_GPIO_TMS_MI_PIN, VSFHAL_GPIO_INPUT | VSFHAL_GPIO_PULLUP);
			vsfhal_gpio_clear(PERIPHERAL_GPIO_TDI_PORT, 0x1 << PERIPHERAL_GPIO_TDI_PIN);
			
			vsfhal_gpio_config(PERIPHERAL_GPIO_TRST_MO_PORT, PERIPHERAL_GPIO_TRST_MO_PIN, VSFHAL_GPIO_INPUT | VSFHAL_GPIO_PULLUP);
			vsfhal_gpio_config(PERIPHERAL_GPIO_TRST_TX1_PORT, PERIPHERAL_GPIO_TRST_TX1_PIN, VSFHAL_GPIO_INPUT | VSFHAL_GPIO_PULLUP);
			vsfhal_gpio_clear(PERIPHERAL_GPIO_TCK0_PORT, 0x1 << PERIPHERAL_GPIO_TCK0_PIN);
			
			vsfhal_gpio_config(PERIPHERAL_GPIO_TX0_PORT, PERIPHERAL_GPIO_TX0_PIN, VSFHAL_GPIO_INPUT | VSFHAL_GPIO_PULLUP);
			vsfhal_gpio_clear(PERIPHERAL_GPIO_SRST_PORT, 0x1 << PERIPHERAL_GPIO_SRST_PIN);
			
			vsfhal_gpio_config(PERIPHERAL_GPIO_TDO_MI_PORT, PERIPHERAL_GPIO_TDO_MI_PIN, VSFHAL_GPIO_INPUT | VSFHAL_GPIO_PULLUP);
			vsfhal_gpio_config(PERIPHERAL_GPIO_TDO_RX1_PORT, PERIPHERAL_GPIO_TDO_RX1_PIN, VSFHAL_GPIO_INPUT | VSFHAL_GPIO_PULLUP);
			vsfhal_gpio_clear(PERIPHERAL_GPIO_RX0_PORT, 0x1 << PERIPHERAL_GPIO_RX0_PIN);
			...
			vsfhal_gpio_config(PERIPHERAL_GPIO_TMS_MI_PORT, PERIPHERAL_GPIO_TMS_MI_PIN, VSFHAL_GPIO_INPUT);
			vsfhal_gpio_config(PERIPHERAL_GPIO_TDI_PORT, PERIPHERAL_GPIO_TDI_PIN, VSFHAL_GPIO_INPUT);
			vsfhal_gpio_config(PERIPHERAL_GPIO_TRST_MO_PORT, PERIPHERAL_GPIO_TRST_MO_PIN, VSFHAL_GPIO_INPUT);
			vsfhal_gpio_config(PERIPHERAL_GPIO_TRST_TX1_PORT, PERIPHERAL_GPIO_TRST_TX1_PIN, VSFHAL_GPIO_INPUT);
			vsfhal_gpio_config(PERIPHERAL_GPIO_TCK0_PORT, PERIPHERAL_GPIO_TCK0_PIN, VSFHAL_GPIO_INPUT);
			vsfhal_gpio_config(PERIPHERAL_GPIO_TX0_PORT, PERIPHERAL_GPIO_TX0_PIN, VSFHAL_GPIO_INPUT);
			vsfhal_gpio_config(PERIPHERAL_GPIO_SRST_PORT, PERIPHERAL_GPIO_SRST_PIN, VSFHAL_GPIO_INPUT);
			vsfhal_gpio_config(PERIPHERAL_GPIO_TDO_MI_PORT, PERIPHERAL_GPIO_TDO_MI_PIN, VSFHAL_GPIO_INPUT);
			vsfhal_gpio_config(PERIPHERAL_GPIO_TDO_RX1_PORT, PERIPHERAL_GPIO_TDO_RX1_PIN, VSFHAL_GPIO_INPUT);
			vsfhal_gpio_config(PERIPHERAL_GPIO_RX0_PORT, PERIPHERAL_GPIO_RX0_PIN, VSFHAL_GPIO_INPUT);
