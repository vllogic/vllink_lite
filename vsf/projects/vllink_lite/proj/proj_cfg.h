...
#	define CMSIS_DAP_V2_BOS_DESC_LENGTH		28
#	define CMSIS_DAP_V2_BOS_COUNT			1
#else
...
#define USBD_CONFIGDESC_LENGTH		(9 + CMSIS_DAP_V1_DESC_LENGTH + CMSIS_DAP_V2_DESC_LENGTH + WEBUSB_DESC_LENGTH + CDCEXT_DESC_LENGTH + CDCSHELL_DESC_LENGTH)
#define USBD_INTERFACE_COUNT		(CMSIS_DAP_V1_INTERFACE_COUNT + CMSIS_DAP_V2_INTERFACE_COUNT + WEBUSB_INTERFACE_COUNT + CDCEXT_INTERFACE_COUNT + CDCSHELL_INTERFACE_COUNT)
