...
#define PERIPHERAL_GPIO_TDI_GET()			(vsfhal_gpio_get(PERIPHERAL_GPIO_TDI_PORT, 1 << PERIPHERAL_GPIO_TDI_PIN) >> PERIPHERAL_GPIO_TDI_PIN)
...
#define PERIPHERAL_GPIO_TMS_GET()			(vsfhal_gpio_get(PERIPHERAL_GPIO_TMS_MI_PORT, 1 << PERIPHERAL_GPIO_TMS_MI_PIN) >> PERIPHERAL_GPIO_TMS_MI_PIN)
...
#define PERIPHERAL_GPIO_TCK_GET()			(vsfhal_gpio_get(PERIPHERAL_GPIO_TCK0_PORT, 1 << PERIPHERAL_GPIO_TCK0_PIN) >> PERIPHERAL_GPIO_TCK0_PIN)
...
#define PERIPHERAL_GPIO_SRST_GET()			(vsfhal_gpio_get(PERIPHERAL_GPIO_SRST_PORT, 1 << PERIPHERAL_GPIO_SRST_PIN) >> PERIPHERAL_GPIO_SRST_PIN)
...
#define PERIPHERAL_GPIO_TDO_GET()			(vsfhal_gpio_get(PERIPHERAL_GPIO_TDO_MI_PORT, 1 << PERIPHERAL_GPIO_TDO_MI_PIN) >> PERIPHERAL_GPIO_TDO_MI_PIN)
...
#define PERIPHERAL_GPIO_TRST_GET()			(vsfhal_gpio_get(PERIPHERAL_GPIO_TRST_MO_PORT, 1 << PERIPHERAL_GPIO_TRST_MO_PIN) >> PERIPHERAL_GPIO_TRST_MO_PIN)
