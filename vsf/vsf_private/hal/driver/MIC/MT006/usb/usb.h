...
#ifndef __HAL_DRIVER_MT006_USB_H__
#define __HAL_DRIVER_MT006_USB_H__
...
#   define __USB_OTG_DEF(__N, __VALUE)                                          \
    extern mt006_usb_t USB_OTG##__N##_IP;                                       \
...
typedef struct mt006_usb_const_t {
    IRQn_Type irq;
    void *reg;
} mt006_usb_const_t;

typedef struct mt006_usb_t {
#if VSF_HAL_USE_USBD == ENABLED && VSF_HAL_USE_USBH == ENABLED
    bool is_host;
#endif
    struct {
...
#endif      // __HAL_DRIVER_MT006_USB_H__
/* EOF */
