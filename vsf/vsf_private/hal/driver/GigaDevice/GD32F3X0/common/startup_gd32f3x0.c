...
ROOT const pFunc __VECTOR_TABLE[] __VECTOR_TABLE_ATTRIBUTE = {
    ...
    SWI1_IRQHandler,                                        /* Reserved */
    CEC_IRQHandler,                           /* Vector Number 46,CEC */
    SWI2_IRQHandler,                                        /* Reserved         */
    I2C0_ER_IRQHandler,                       /* Vector Number 48,I2C0 Error */
    SWI3_IRQHandler,                                        /* Reserved     */
    I2C1_ER_IRQHandler,                       /* Vector Number 50,I2C1 Error */
    SWI4_IRQHandler,                                        /* Reserved */
    SWI5_IRQHandler,                                        /* Reserved */
    SWI6_IRQHandler,                                        /* Reserved */
    SWI7_IRQHandler,                                        /* Reserved */
    SWI8_IRQHandler,                                        /* Reserved  */
    SWI9_IRQHandler,                                        /* Reserved  */
    0,                                        /* Reserved  */
